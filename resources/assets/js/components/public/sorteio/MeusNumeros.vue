        ...
        <div class="col-12 mb-2" @click="redirecionarPaginaSorteio(sorteio)">
          ...
          <div class="SorteioTpl_sorteioTpl__2s2Wu   pointer">
            ...
            <div class="SorteioTpl_info__t1BZr" style="width: 70%;">
              ...
              <h3 class="SorteioTpl_descricao__1b7iL" style="margin-bottom:1px; line-height: 1.4em;">Valor da compra:
                <b>{{ sorteio.valor_da_compra }}</b></h3>
              <h3 class="SorteioTpl_descricao__1b7iL" style="margin-bottom:1px; line-height: 1.4em;">Data da compra: <b>
                {{ sorteio.created_at }} </b></h3>
              <h3 class="SorteioTpl_descricao__1b7iL" style="margin-bottom:1px; line-height: 1.4em;">Status da compra:
          ...
          <div class="modal-body checkout">
            ...
            <div class="mb-2">
              ...
              <input id="uc_telefone_checkout" v-model="telefone" v-telefone
                     class="form-control mascaraCelular" inputmode="numeric" maxlength="14" name="uc_telefone_checkout"
                     placeholder="(xx)xxxxx-xxxx"
                     required="" type="text" @blur="validarFormatoTelefone()">
            </div>
            <div class="alert alert-warning p-2 font-xss mb-2"><i class="bi bi-exclamation-circle"></i> Informe seu
              telefone para continuar.
            </div>
            <button id="botaoContiuarCheckout" class="btn btn-primary btn-wide" @click="getSorteios()">Continuar <i
