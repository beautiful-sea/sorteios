        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="/rifas/{{$rifa->id}}" method="post" class="form" enctype="multipart/form-data" id="formRifa">
                            @csrf
                            @method('put')
                            <div class="row">
                                <div class="col-md-6 col-12">
                                    <div class="mb-1">
                                        ...
                                        <input value="{{$rifa->titulo}}" type="text" id="titulo" class="form-control" name="titulo">
                                    </div>
                                </div>
                                <div class="col-md-6 col-12">
                                    <div class="mb-1">
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="mb-1">
                                        ...
                                        <input value="{{$rifa->resumo}}" type="text" id="resumo" class="form-control"   name="resumo">
                                    </div>
                                </div>
                                <div class="card-header">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="tab-content pt-1">
                                            ...
                                            <div class="row">
                                                <div class="col-md-6 col-12">
                                                    <div class="mb-1">
                                                        ...
                                                        <input value="{{$rifa->premio}}" type="text" id="premio" class="form-control" name="premio" >
                                                    </div>
                                                </div>
                                                <div class="col-md-6 col-12">
                                                    <div class="mb-1">
                                                        ...
                                                        <div class="form-check form-switch">
                                                            <input value="{{$rifa->status}}" type="checkbox" class="form-check-input" id="status">
                                                ...
                                                <div class="col-md-6 col-12">
                                                    <div class="mb-1">
                                                        ...
                                                        <div class="form-check form-switch">
                                                            <input value="{{$rifa->mostrar_data_sorteio}}" type="checkbox" class="form-check-input" id="mostrar_data_sorteio">
                                                ...
                                                <div class="col-md-6 col-12">
                                                    <div class="mb-1">
                                                        ...
                                                        <input value="{{$rifa->periodo}}"   type="datetime-local" id="periodo" class="form-control" name="periodo" >
                                                    </div>
                                                </div>
                                                <div class="col-md-6 col-12">
                                                    <div class="mb-1">
                                                        <label class="form-label" for="valor_por_numero">Valor por número (R$) *</label>
                                                        <input value="{{$rifa->valor_por_numero}}" type="text" id="valor_por_numero" class="form-control" name="valor_por_numero" >
                                                    </div>
                                                </div>
                                                <div class="col-md-6 col-12">
                                                    <div class="mb-1">
                                                        <label class="form-label" for="quantidade_de_numeros">Quantidade de Números *</label>
                                                        <input value="{{$rifa->quantidade_de_numeros}}" type="number" id="quantidade_de_numeros" class="form-control" name="quantidade_de_numeros" >
                                                    </div>
                                                </div>
                                                <div class="col-md-6 col-12">
                                                    <div class="mb-1">
                                                        <label class="form-label" for="quantidade_maxima_de_numeros">Quantidade máxima de Números *</label>
                                                        <input value="{{$rifa->quantidade_maxima_de_numeros}}" type="number" id="quantidade_maxima_de_numeros" class="form-control" name="quantidade_maxima_de_numeros" >
                                                    </div>
                                                </div>
                                                <div class="col-md-6 col-12">
                                                    <div class="mb-1">
                                                        <label class="form-label" for="porcentagem_comissao_vendas">Porcentagem de comissão por vendas (%)</label>
                                                        <input value="{{$rifa->porcentagem_comissao_vendas}}" type="number" id="porcentagem_comissao_vendas" class="form-control" name="porcentagem_comissao_vendas" >
                                                    </div>
                                                </div>
                                                <div class="col-md-6 col-12">
                                                    <div class="mb-1">
                                                        ...
                                                        <div class="form-check form-switch">
                                                            <input value="{{$rifa->has_compra_minima}}" type="checkbox" class="form-check-input" id="has_compra_minima">
                                                ...
                                                <div class="col-md-6 col-12">
                                                    <div class="mb-1">
                                                        ...
                                                        <input value="{{$rifa->contato_whatsapp}}" type="text" id="contato_whatsapp" class="form-control" name="contato_whatsapp" >
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-6 col-12">
                                                    <div class="mb-1">
                                                        ...
                                                        <div class="form-check form-switch">
                                                            <input value="{{$rifa->is_compra_automatica}}" type="checkbox" class="form-check-input" id="is_compra_automatica">
                                            ...
                                            <div class="row">
                                                <div class="col-12">
                                                    <div class="mb-1">
                                                        ...
                                                        <div class="form-check form-switch">
                                                            <input value="{{$rifa->has_top_five}}" type="checkbox" class="form-check-input" id="has_top_five">
                                                ...
                                                <div class="col-12">
                                                    <div class="mb-1">
                                                        ...
                                                        <input value="{{$rifa->premio_top_five}}" type="text" name="premio_top_five" class="form-control" id="premio_top_five" placeholder="Um Pix de R$ 1.500,00">
                                                    </div>
                                                </div>
                                                <div class=" col-12">
                                                    <div class="mb-1">
                                                        ...
                                                        <div class="form-check form-switch">
                                                            <input value="{{$rifa->definir_ganhador_top_five}}" type="checkbox" class="form-check-input" id="definir_ganhador_top_five">
                                        ...
                                        <div class="tab-pane" id="imagens-fill" role="tabpanel" aria-labelledby="imagens-tab-fill">
                                            ...
                                            <div class="row">
                                                @foreach($rifa->imagens as $imagem)
                                                    <div class="col-3">
                                                        <img src="{{\Storage::url($imagem->path)}}">
                                                    </div>
                                                    @endforeach
                                            </div>
                                        </div>
                                        ...
                                        <div class="tab-pane" id="whatsapp-fill" role="tabpanel" aria-labelledby="whatsapp-tab-fill">
                                            <div class="col-12">
                                                <div class="mb-1">
                                                    ...
                                                    <div class="form-check form-switch">
                                                        <input value="{{$rifa->has_botao_whatsapp}}" type="checkbox" class="form-check-input" id="has_botao_whatsapp">
                                            ...
                                            <div class="col-12">
                                                <div class="mb-1">
                                                    ...
                                                    <input value="{{$rifa->texto_botao_whatsapp}}" type="text" class="form-control" id="texto_botao_whatsapp">
                                                </div>
                                                <div class="mb-1">
                                                ...
                                                <div class="mb-1">
                                                    ...
                                                    <input value="{{$rifa->contato_botao_whatsapp}}" type="text" class="form-control" id="contato_botao_whatsapp">
                                                </div>
                                                <div class="mb-1">
                                                    <label class="form-label" for="id_grupo_botao_whatsapp">ID do grupo do Whatsapp *</label>
                                                    <input value="{{$rifa->id_grupo_botao_whatsapp}}" type="text" class="form-control" id="id_grupo_botao_whatsapp">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="tab-pane" id="numero_sorteado-fill" role="tabpanel" aria-labelledby="numero_sorteado-tab-fill">
                                            <div class="mb-1">
                                                ...
                                                <input value="{{$rifa->numero_sorteado}}" type="text" class="form-control" name="numero_sorteado" id="numero_sorteado">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-12">
                                    ...
                                    @endif
                                    <button type="submit" class="btn btn-primary me-1 waves-effect waves-float waves-light">Salvar</button>
